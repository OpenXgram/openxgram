...
import { AgentMessengerCard} from "./components/AgentMessengerCard";
...
function AppInner() {
 ...
 case "agents-messenger": setTab("card-agents-messenger"); break;
 ...
 <Show when={tab() === "card-agents-messenger"}>
 <AgentMessengerCard onBack={() => setTab("home")} />
 </Show>
 </main>
 </Show>
