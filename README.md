...
[![Version](https://img.shields.io/badge/version-0.2.0--rc.24-blue)](https://github.com/OpenXgram/openxgram/blob/main/version.json)
...
> 빌드 시간 30분 → 5분, 추가 다운로드 0, HTTPS 자동(Let's Encrypt). 자세한 건 [`ui/tauri/DEPRECATED.md`](ui/tauri/DEPRECATED.md).
...
- ✅ ~~Tauri GUI — 데스크톱 베이스라인~~ → **웹 GUI (Tailscale Funnel)** 로 전환 (rc.24, `ui/tauri/DEPRECATED.md`)
