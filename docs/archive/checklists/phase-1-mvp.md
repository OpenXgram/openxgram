...
> **상태: ✅ COMPLETED — v0.1.0 (2026-05-04 KST) Phase 1 GA 출하 완료.**
> 실제 출하된 표면·기능은 [CHANGELOG.md](../../CHANGELOG.md) `[0.1.0]` 섹션을 참조하세요.
> 이 파일은 Phase 1 계획·범위 산정 시 사용한 원본 plan으로, 역사적 참조용으로 보존됩니다.
> 항목별 체크박스는 토글하지 않습니다(개별 진행 추적은 PR/CHANGELOG로 대체).

버전: v0.1.0 (GA, 2026-05-04)
원래 목표: 5~6주 내 핵심 기능 동작 → 달성
